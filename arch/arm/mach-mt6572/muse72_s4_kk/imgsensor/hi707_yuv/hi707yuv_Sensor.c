...
extern int soc_antibanding; //[LGE_UPDATE] [yonghwan.lym@lge.com] [2014-02-18] soc sensor Manual Flicker
static void HI707_Init_Parameter(void)
{
    ...
    HI707_sensor.banding = soc_antibanding; //[LGE_UPDATE] [yonghwan.lym@lge.com] [2014-02-18] soc sensor Manual Flicker
...
UINT32 HI707YUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    SENSORDB("HI707_sensor.video_mode = %d\n",HI707_sensor.MPEG4_Video_mode);
    HI707_sensor.video_fps = u2FrameRate;
...
{
    *pFeatureReturnPara32 = 1;	//[LGE_UPDATE][youmi.jun@lge.com][2014.02.17] Add touch AE
    SENSORDB("HI707GetAEMaxNumMeteringAreas *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);
}
//[LGE_UPDATE_S][youmi.jun@lge.com][2014.02.17] Add touch AE
...
//[LGE_UPDATE_E][youmi.jun@lge.com][2014.02.17] Add touch AE
...
void HI707GetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->FNumber = 30;              // [LGE_UPDATE][youmi.jun@lge.com][2014.03.39] Modify FNumber
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = HI707_sensor.wb;
    pExifInfo->CapExposureTime = 0;
    pExifInfo->FlashLightTimeus = 0;
    pExifInfo->RealISOValue = AE_ISO_100;
    pExifInfo->FocalLength = 129;         // [LGE_UPDATE][youmi.jun@lge.com][2014.03.39] Add FocalLength (1.295)
}
